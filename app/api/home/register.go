...
var MethodTags = map[string]string{
	"go-project/app/api/home/user/controller.AccountController.Register": "POST",
	"go-project/app/api/home/user/controller.AccountController.Login": "POST",
	"go-project/app/api/home/user/controller.AccountController.Logout": "POST",
	"go-project/app/api/home/user/controller.AccountController.Delete": "GET",
...
func init() {
	RegisterController(controller0.AccountController{})
}
